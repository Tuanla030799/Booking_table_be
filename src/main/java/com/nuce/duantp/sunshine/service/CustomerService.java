...
public class CustomerService {
    ...
    public List<BookingHistoryRes> viewBookingHistory(HttpServletRequest req) {
        ...
        for (tbl_Booking booking : bookingList) {
            ...
            BookingHistoryRes data1 = new BookingHistoryRes(date, FormatMoney.formatMoney(String.valueOf(deposit.getDeposit())), status, FormatMoney.formatMoney(String.valueOf(money)), stt, booking.getBookingId(), FormatMoney.formatMoney(String.valueOf(refund)));
            data.add(data1);
            stt++;
