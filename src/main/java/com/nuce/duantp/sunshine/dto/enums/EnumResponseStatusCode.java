...
public enum EnumResponseStatusCode {
    ...
    CANCEL_CHARGING_SUCCESS("Huỷ nạp tiền thành công."),
    ...
    STATUS_NOT_FOUND("Trạng thái không đúng!"),
    TRANSACTION_NOT_FOUND("Không tìm thấy giao dịch!"),
    INVALID_OPERATION("Giao dịch đã bị huỷ!"),
    ...
    ACC_NOT_EXIST("Tài khoản không tồn tại!"),
    ...
    CUSTOMER_CHARGING("Đợi admin xác nhận!"),
